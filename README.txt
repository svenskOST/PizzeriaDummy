...
VSCode extensions till detta projekt:
	...
	- Material Icon Theme (estetiskt)
	- Tailwind Fold (estetiskt)
	- Prettier (struktur - krävs även för projektets automatiska sortering av Tailwind-klasser)
	- Tailwind CSS IntelliSense (funktionallitet)
